...
export default function PostFooter( { comments , postId } ) {
  ...
  <div className="w-full h-8 flex items-center px-3 my-3">
            ...
            <div className="grid grid-cols-3 w-full px-5 my-3 border border-s-0 border-e-0 border-t py-3 border-divider">
              ...
              <button className="flex flex-row justify-center items-center w-full space-x-3"><svg className='' xmlns="http://www.w3.org/2000/svg" width={27} height={27} viewBox="0 0 24 24" fill="none" stroke="#838383" strokeWidth={2} strokeLinecap="square" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
